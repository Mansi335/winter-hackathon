        ...
        <div className="bg-white rounded-lg shadow-lg mb-8">
          <div className="flex flex-wrap border-b border-gray-200">
            {[
              ...
              { id: 'emotion', label: 'Emotion Recognition', icon: '😊' },
              { id: 'games', label: 'Learning Games', icon: '🎮' },
              { id: 'focus', label: 'Focus Trainer', icon: '👁️' },
              { id: 'dashboard', label: 'Parent Dashboard', icon: '📊' },
            ].map((module) => (
              <button
                key={module.id}
              ...
              <div className="space-y-6">
                ...
                <div className="bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg p-8">
                  ...
                  <div className="bg-white rounded-lg p-6 mb-6">
                    <h4 className="font-semibold text-gray-700 mb-4">Language Selection</h4>
                  ...
                  <div className="bg-gradient-to-br from-pink-50 to-purple-50 rounded-lg p-6">
                    ...
                    {emotion ? (
                      <div className="text-center">
                        ...
                        <p className="text-2xl font-bold text-gray-800 capitalize mb-4">
                          {emotion}
                        </p>
                        {emotion === 'sad' && (
                      ...
                      <div className="grid grid-cols-3 md:grid-cols-6 gap-4 mb-6">
                        {shapes.map((shape) => (
                          <button
                            ...
                            className={`h-24 rounded-lg bg-blue-200 hover:bg-blue-300 transition-all transform hover:scale-110 flex items-center justify-center ${
